...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fa fa-eye"></i> Detail Alumni</h1>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Identitas Alumni</a></li>
                 
                  <li class="nav-item"><a class="nav-link" href="#wali" data-toggle="tab">Identitas Wali</a></li>
                     </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php foreach($alumni as $a):?>
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->tempat_lhr ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->tgl_lhr ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->angkatan ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->jurusan ?> >
                        </div>
                      </div>


                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Marhalah</label>
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->marhalah ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->pekerjaan ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->kecamatan ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->kabupaten ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->provinsi ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" disabled class="form-control"  value=<?= $a->password ?> >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                         <a href="<?= base_url('Alumni') ?>" class="btn btn-warning">Selesai</a>
                        </div>
                        </div>
                    </form>
                  ...
                  <?php foreach($wali as $a):?>
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" value=<?= $a->nama_ayah ?> disabled class="form-control" >
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea name="" id="" class="form-control" disabled><?= $a->pekerjaan_ayah ?> </textarea>
                       </div>
                      </div>
                      <div class="form-group row">
